...
**15 departments · 200 source skills · 84 vendored seats · 182 mirrored commands · hard-gated matter pipeline · MCP/API intake · X402 paid-agent matrix · Conway agent-life scheduler · FBI-style fraud dossiers · source-first bookkeeping with Google Sheets input + OCR orchestration · PROPHET-ACTUARY actuarial validation · enterprise accounting assurance · legal reasoning benchmarks. Attorney/CPA/actuary work-product for licensed professional review, not legal, tax, accounting, or actuarial advice.**
...
| **Actuarial, Insurance Risk & Prophet** | Insurance modeling, Prophet implementation, actuarial validation, risk, regulatory accounting, and governed release | `/glaw-actuary-prophet-governor`, `/glaw-actuary-prophet-architect`, `/glaw-actuary-quant-validation`, `/glaw-actuary-regulatory-accounting` |
