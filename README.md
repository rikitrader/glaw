...
**11 departments · 198 source skills · 82 vendored seats · 182 mirrored commands · hard-gated matter pipeline · MCP/API intake · X402 paid-agent matrix · Conway agent-life scheduler · FBI-style fraud dossiers · source-first bookkeeping with Google Sheets input + OCR orchestration · PROPHET-ACTUARY actuarial validation. Attorney/CPA/actuary work-product for licensed professional review, not legal, tax, accounting, or actuarial advice.**
