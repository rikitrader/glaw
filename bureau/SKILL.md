...
| Forensic accounting / asset tracing / money-laundering / beneficial owners | `financial-forensics` + `/glaw-accounting` |
...
| Deep forensic case build (RED→BLUE) | `forensic-case-investigator` + `/glaw-investigations` |
