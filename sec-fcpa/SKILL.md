...
follow-the-money and shell/intermediary tracing → `financial-forensics` and
`forensic-case-investigator`; sanctions/PEP and wire-routing facts → `/glaw-fincen-ofac`;
