...
the should-we-actually-file-this judgment routes to `federal-trial-counsel` and
`elite-corporate-counsel`. Every draft carries the UPL footer.
...
- **Motion to vacate — Fla. R. Civ. P. 1.540 / Fed. R. Civ. P. 60(b).** Grounds: mistake,
  ...
  void/fraud-on-court). Cross-ref `elite-corporate-counsel` for fraud-on-the-court.
...
with the **Agent** tool, each routed to its responsible seat (`federal-trial-counsel`
for federal posture, `elite-corporate-counsel` for commercial/FL state). Argue in
...
- **Substantive litigation judgment** (should we file, will it survive, what's the risk)
  → `federal-trial-counsel` + `elite-corporate-counsel`.
...
file and the litigation judgment belong to `federal-trial-counsel` and
`elite-corporate-counsel`; every citation is verified by `/glaw-legal-research`. The
