...
## Handoffs
- **Trademark/patent litigation & enforcement strategy** → `elite-corporate-counsel` / `federal-trial-counsel`.
- **Patent application drafting/prosecution** → USPTO-registered patent practitioner (reserved practice).
- **Tax of IP holdcos / IP migration / R&D credit** → `tax-strategy`.
- **Securities treatment of IP contributed to an entity** → `pe-vc-counsel`.
