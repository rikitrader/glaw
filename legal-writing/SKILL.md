...
| Need | Seat |
|------|------|
| General prose polish, persuasion, headline/lede | `copywriting` |
| Grammar, consistency, line-editing pass | `copy-editing` |
| Structured document assembly from a template | `document-generate` |
| Render to PDF (briefs, letters, exhibits) | `make-pdf` |
| Render to Word for attorney redline | `docx` |
| Marketing / website copy for the practice | `copywriting`, `seo-content` |
...
Delegate the prose-level grind to `copywriting` / `copy-editing` and keep the legal frame
...
- `make-pdf` for filing-ready briefs, demand letters, and exhibit sets (caption block, line numbering, signature block, certificate of service as applicable).
- `docx` when the attorney needs to redline before signing.
