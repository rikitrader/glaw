...
```bash
docker build -f packaging/Containerfile -t ghcr.io/rikitrader/glaw:1.3.0 .
docker tag ghcr.io/rikitrader/glaw:1.3.0 ghcr.io/rikitrader/glaw:latest
docker push ghcr.io/rikitrader/glaw:1.3.0
