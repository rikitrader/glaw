...
```bash
docker build -f packaging/Containerfile -t ghcr.io/rikitrader/glaw:1.2.3 .
docker tag ghcr.io/rikitrader/glaw:1.2.3 ghcr.io/rikitrader/glaw:latest
docker push ghcr.io/rikitrader/glaw:1.2.3
