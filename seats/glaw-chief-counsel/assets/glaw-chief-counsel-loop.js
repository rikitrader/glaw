...
const DRAFTS = '/Users/ricardoprieto/.glaw/matters/roof10x-inc-delaware-c-corp-formation/drafts'
const FOLDER = '1RVaSyGV6mWfgUaKS2W1UCv9qYzxa4Qww'
const ROSTER = '/Users/ricardoprieto/.claude/skills/glaw/lib/firm-roster.md'
const MAX_ROUNDS = 2
...
const guard = await agent(
  ...
  `python3 /Users/ricardoprieto/.claude/skills/glaw/bin/matter-ops/facts_validate.py roof10x-inc-delaware-c-corp-formation`,
...
const comments = await agent(
  `Run: python3 /Users/ricardoprieto/.claude/skills/glaw-83b-election/bin/review_comments.py ${FOLDER}. ` +
...
const priorLearnings = await agent(
  ...
  `(1) run via Bash and include verbatim: python3 /Users/ricardoprieto/.claude/skills/glaw/bin/glaw-learnings preflight; ` +
...
const learned = await agent(
  ...
  `python3 /Users/ricardoprieto/.claude/skills/glaw/bin/glaw-learnings add ` +
  ...
  `meta-rules from the accumulated ledger: python3 /Users/ricardoprieto/.claude/skills/glaw/bin/glaw-reflect --apply. ` +
  `Return the list of learnings recorded + the new ledger stat ` +
  `(run: python3 /Users/ricardoprieto/.claude/skills/glaw/bin/glaw-learnings stats).`,
...
if (allClear){
  ...
  finalize = await agent(
    ...
    `bash /Users/ricardoprieto/.claude/skills/glaw/bin/matter-ops/assemble_package.sh ` +
    `/Users/ricardoprieto/.glaw/matters/roof10x-inc-delaware-c-corp-formation /private/tmp/irs_forms ` +
    ...
    `python3 /Users/ricardoprieto/.claude/skills/glaw/bin/matter-ops/publish_drafts_to_drive.py ${FOLDER} ` +
