...
| Tax / IRS-CI forensic numbers | `glaw-financial-forensics` + `glaw-tax-strategy` + `glaw-tax-compliance` |
...
**Domain:** command professional domain, evidence, controls, and accountable human-review routing.
