...
Read `~/.claude/skills/glaw/lib/firm-roster.md` so entity-structure and employment
...
`tax-strategy`). The cap table and the visa must be designed together.
...
- **Tax of equity grants / residency / treaty positions** → `tax-strategy`.
