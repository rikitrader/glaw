---
name: glaw-contract-review
version: 1.0.0
description: "GLAW ingested seat — Review legal contracts, NDAs, employment agreements, SaaS terms, and M&A documents. Identifies unfavorable terms, suggests redlines, and compares to market standards. Use for contract analysis, due diligence, or negotiation prep."
allowed-tools:
  - Skill
  - Bash
  - Read
  ...
  - Edit
  - AskUserQuestion
triggers: [contract review, glaw contract review]
---

# Contract Review Skill

## When to invoke this skill
Use this GLAW-native ingested seat when a matter needs the `/glaw-contract-review` capability, or when `lib/firm-roster.md` routes work to `/glaw-contract-review`. Keep GLAW hard gates intact: conflicts, citations, adversarial review, and UPL disclaimer.
...
- Soul: `glaw-contract-review` carries a distinct professional judgment posture for this seat; its reports must preserve its own lens, skepticism, evidence standards, red flags, and sign-off conditions instead of blending into a generic firm voice.
...
**Domain:** contract review professional domain, evidence, controls, and accountable human-review routing.
